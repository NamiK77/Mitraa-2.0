...
const GameSetUpScreen = () => {
  ...
  // Check if the current user is in the accepted players list
  const isAcceptedPlayer = players?.some(player => player._id === userId);
  console.log('Is Accepted Player:', isAcceptedPlayer);

  // Check if user is already a player
  const isAlreadyJoined = players?.some(player => player._id === userId) || false;

  // Function to handle join game press
        ...
        <ScrollView>
          ...
          {/* <View style={{marginHorizontal: 15}}>
            <Image
              ...
              source={require('../images/Discount.jpg')} // Adjust path as needed
            />
          </View> */}
